...
class MLPActorCritic(nn.Module):
    ...
    def __init__(self, observation_space, action_space, 
                 hidden_sizes=(64,64), activation=nn.Tanh, d_h_size=(512, 512), d_ouput=7, d_activation=nn.ReLU):
        super().__init__()
        ...
        # build distributional value function
        self.d_v  = MLPDCritic(obs_dim, d_h_size, d_ouput, d_activation)
