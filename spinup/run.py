...
MPI_COMPATIBLE_ALGOS = ['vpg', 'trpo', 'ppo', 'ppo_detach', 'mc_clt_ppo', 'dppo', 'trpo', 'dtrpo', 'mc_clt_trpo']

# Algo names (used in a few places)
BASE_ALGO_NAMES = ['vpg', 'trpo', 'ppo', 'ppo_detach', 'ddpg', 'td3', 'sac', 'mc_clt_ppo', 'dppo', 'trpo', 'dtrpo', 'mc_clt_trpo']
